          ...
          {BASELINE.layers.map((layer, i) => {
            ...
            return (
              <StaggerItem key={layer.title}>
                <div className="group h-full rounded-lg bg-white p-8 shadow-[0_10px_34px_-26px_rgba(18,69,41,0.35)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_22px_48px_-24px_rgba(18,69,41,0.35)] md:p-9">
