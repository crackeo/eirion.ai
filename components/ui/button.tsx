...
const variantStyles: Record<Variant, string> = {
  gold: "bg-gradient-to-r from-gold-600 via-gold-500 to-gold-600 bg-[length:200%_auto] text-forest-950 shadow-[0_8px_30px_-6px_rgba(201,162,39,0.55)] hover:bg-right",
  forest:
    "bg-forest-700 text-white shadow-[0_8px_30px_-8px_rgba(16,85,34,0.6)] hover:bg-forest-600",
  "ghost-dark":
