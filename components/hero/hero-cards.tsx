...
const card =
  "absolute overflow-hidden rounded-[2.6cqw] border border-forest-200/80 bg-white shadow-[0_2.6cqw_6cqw_-2cqw_rgba(5,43,20,0.3)]";
const label =
...
function McpOrb() {
  return (
    <div
      className="absolute left-[21.8%] top-[52.8%] grid size-[16.5cqw] place-items-center rounded-full bg-gradient-to-br from-forest-400 via-forest-600 to-forest-800 text-center shadow-[0_0_6.5cqw_1.3cqw_rgba(31,122,83,0.6)] ring-[0.45cqw] ring-white/70"
    >
      <div>
